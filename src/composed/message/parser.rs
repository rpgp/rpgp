...
use super::reader::PacketBodyReader;
...
impl Message<'_> {
    ...
    pub fn from_packets<'a, I: Iterator<Item = Result<Packet>> + 'a>(
    ...
    pub fn from_bytes<R: BufRead>(source: R) -> Result<Self> {
        ...
        Self::from_packets(parser.peekable())
    }
    ...
    /// From armored string
    pub fn from_string(data: &str) -> Result<(Self, crate::armor::Headers)> {
    ...
    /// Armored ascii data.
    pub fn from_armor<R: BufRead>(input: R) -> Result<(Self, crate::armor::Headers)> {
