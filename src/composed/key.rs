            ...
            |k| {
                ...
                match k {
                    types::key::PrivateKeyRepr::RSA(k) => {
                        ...
                        assert_eq!(k.d().to_vec(), hex!("").to_vec());
                        assert_eq!(k.p().unwrap().to_vec(), hex!("C62B8CD033331BFF171188C483B5B87E41A84415A004A83A4109014A671A5A3DA0A467CDB786F0BB75354245DA0DFFF53B6E25A44E28CBFF8CC1AC58A968AF57").to_vec());
                        assert_eq!(k.q().unwrap().to_vec(), hex!("C831D89F49E642383C115413B2CB5F6EC09012B50C1E8596877E8F7B88C82C8F14FC354C21B6032BEF78B3C5EC92E434BEB2436B12C7C9FEDEFD866678DBED77").to_vec());
                    }
