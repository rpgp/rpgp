...
use packet::types::{PublicKeyAlgorithm, Tag};
use types::KeyId;
...
impl Packet for OnePassSignature {
    fn tag(&self) -> Tag {
...
named!(parse<OnePassSignature>, do_parse!(
         version: be_u8
    >>       typ: map_res!(be_u8, SignatureType::from_u8)
    >>      hash: map_res!(be_u8, HashAlgorithm::from_u8)
    >>   pub_alg: map_res!(be_u8, PublicKeyAlgorithm::from_u8)
