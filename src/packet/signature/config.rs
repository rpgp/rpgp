...
impl SignatureConfig {
    pub fn from_key<RNG: CryptoRng + RngCore, S: SigningKey>(
        rng: &mut RNG,
        key: &S,
        typ: SignatureType,
    ) -> Result<Self> {
    ...
    fn v6_salt_for<R: CryptoRng + RngCore>(
        rng: &mut R,
        hash_alg: HashAlgorithm,
    ) -> Result<Vec<u8>> {
    ...
    /// Sign the given data.
    pub fn sign<R, RNG: CryptoRng + RngCore>(
        self,
        rng: &mut RNG,
        key: &impl SigningKey,
        key_pw: &Password,
    ...
    pub fn sign_certification<S, K, RNG: CryptoRng + RngCore>(
        self,
        rng: &mut RNG,
        key: &S,
        pub_key: &K,
    ...
    pub fn sign_certification_third_party<K, RNG: CryptoRng + RngCore>(
        self,
        rng: &mut RNG,
    ...
    pub fn sign_subkey_binding<RNG: CryptoRng + RngCore, S, K1, K2>(
        self,
        rng: &mut RNG,
        signer: &S,
        signer_pub: &K1,
    ...
    pub fn sign_primary_key_binding<RNG: CryptoRng + RngCore, S, K1, K2>(
        self,
        rng: &mut RNG,
        signer: &S,
        signer_pub: &K1,
    ...
    pub fn sign_key<RNG1: CryptoRng + RngCore, S, K>(
        self,
        rng: &mut RNG1,
        signing_key: &S,
        key_pw: &Password,
...
impl SignatureHasher {
    ...
    pub fn sign<RNG: CryptoRng + RngCore, S>(
        self,
        rng: &mut RNG,
        key: &S,
        key_pw: &Password,
